...
import com.dj.auth.domain.PasswordValidationState
import com.dj.auth.domain.UserDataValidator
import com.dj.auth.presentation.R
import com.dj.core.presentation.designsystem.CheckIcon
import com.dj.core.presentation.designsystem.CrossIcon
    ...
    ObserveAsEvents(flow = viewModel.events) { event ->
        when (event) {
            RegisterEvent.RegistrationSuccess -> {
                ...
                Toast.makeText(context, R.string.registration_successful, Toast.LENGTH_LONG)
                    .show()
            ...
            is RegisterEvent.Error -> {
                keyboardController?.hide()
                Toast.makeText(context, event.error.asString(context = context), Toast.LENGTH_LONG)
                    .show()
            }
        }
    }
...
private fun RegisterScreen(
    ...
    GradientBackground {
        Column(
            ...
            RunActionButton(
                text = stringResource(id = R.string.register), isLoading = state.isRegistering,
